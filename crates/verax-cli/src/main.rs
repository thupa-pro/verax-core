...
#[command(
    name = "verax",
    version,
    about = "Verax Protocol — verifiable provenance for any artifact",
...
and Merkle-tree transparency logging.",
    after_help = "See 'verax examples' for end-to-end walkthroughs."
)]
struct Cli {
...
#[derive(Subcommand)]
enum Commands {
    /// Initialize a new Verax project in the current directory
    Init,
