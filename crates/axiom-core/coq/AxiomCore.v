(* ─── Axiom Protocol v3.0 Core Invariants ────────────────────────────────────
 *
 * This formalization models the Axiom Protocol v3.0 DAG-based provenance
...
(* A payload is the semantic content of an Axiom statement. *)
...
(* A lineage pointer is a hash pointing to the parent statement.
   The Axiom DAG is a forest — every node has at most one parent
